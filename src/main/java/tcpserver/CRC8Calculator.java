...
public class CRC8Calculator{
	...
	/*
	 * Coundn't make the algorithm work to calculate this table at runtime in Java,
	 * Java approaches uses >>> bitwise operator, which i had many Issues with
	 * So I'm defining the table with the possible divisions manually here
	 * This is memory consuming, but it helps by speeding up message processing
	 * by enabling a byte by byte processing.
	 */
